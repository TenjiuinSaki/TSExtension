...
//    }
    ...
    static var wScale: CGFloat {
        if CGFloat.screenWidth < 700 {
            return CGFloat.screenWidth / 375
        } else {
            return CGFloat.screenWidth / 768 * 1.3
        }
    }
    static var hScale: CGFloat {
        if CGFloat.screenHeight < 1000 {
            return CGFloat.screenHeight / 667
        } else {
            return CGFloat.screenHeight / 1024 * 1.8
        }
    }
}
